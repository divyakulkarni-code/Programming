...
def replace_third_and_last(input_list):
    ...
    third_element = last_element = 37

    input_list[2] = third_element
    input_list[-1] = last_element
...
def delete_third_and_seventh(input_list):
    ...
    seventh_element = input_list[6]

    input_list.remove(third_element)
    input_list.remove(seventh_element)
